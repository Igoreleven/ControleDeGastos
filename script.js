...
const money_exit = document.getElementById('money_exit')
...
const updateBalance = () => {
    ...
    let balanceTotal = transactions.reduce((receita, gastos) => receita + gastos, 0).toFixed(2)
